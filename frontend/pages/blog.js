...
import EventCard from "../components/BlogCard";
import Modal from "../components/BlogCard/Modal.component";
  ...
  return isLoading ? (
    ...
    <div className={s.container}>
      ...
      <div>
        ...
        <Title title="OUR BLOGS" font="45" margin="75" />
          ...
          {events.map((blog) => {
            return (
              <EventCard
                key={blog.id}
                img={blog.Image}
                title={blog.EventName}
                description={blog.Description}
                short_info={blog.blogName}
