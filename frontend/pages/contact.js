          ...
          <div class="flex flex-col lg:flex-row lg:items-center text-slate-900 dark:text-gray-200 lg:justify-between -mx-4">
            ...
            >
              <div class="max-w-[570px] mb-12 lg:mb-0">
                <p class="text-2xl underline underline-offset-2 decoration-yellow-500  font-serif text-blue-500  mx-5">
                  LOCATION
                </p>
                <p class="text-base  font-extrabold text-body-color leading-relaxed mb-9 mx-5">
                  National Institute of Technology Durgapur West Bengal, India
                </p>
                <p class="text-2xl underline underline-offset-2 decoration-yellow-500  font-serif text-blue-500  mx-5">
                  Contact Info :
                </p>
                <p class="text-base  font-bold text-body-color leading-relaxed   mx-5">
                  Harshit Surana:
                  <span class="font-bold text-blue-600 italic">
                  
                    +91 980-006-2969
                  </span>
                </p>
                <p class="text-base  font-bold leading-relaxed  mb-9 mx-5">
                  Ritabrata Ganguly :
                  <span class="font-bold text-blue-600 italic">
                ...
                <p class="text-base  font-medium text-body-color leading-relaxed mb-9 mx-5">
                  Email :
