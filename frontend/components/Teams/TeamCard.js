...
function TeamCard({d , i}) {
  return (
    <div className=" h-[400px]  w-[250px] bg-white  transition-all duration-500 hover:scale-110 hover:shadow-lg hover:shadow-slate-400 rounded-2xl border-2 m-6 group">
      <Image
