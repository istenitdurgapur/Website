    ...
    <div className="flex-col  justify-center items-center mt-8 mb-10">
        ...
        <div className="flex flex-col sm:flex-row  justify-center items-center mt-8 w-full">
          {data.map(function (d, i) {
            return (
                <div key={i} className=" h-[400px]  w-[250px] bg-white  transition-all duration-500 hover:scale-110 hover:shadow-lg hover:shadow-slate-400 rounded-2xl border-2 m-6 group">
                  <Image
